#!/usr/bin/env python3
"""
48³ isotropic cube, highly input-driven, minimal inner echoes
-------------------------------------------------------------
• input_gain=4.2, w0=0.6, bias=0.015, rho=0.78, d_theta=0.27
• firing ≈ 6–7%, but spikes concentrate on and around the input
• inner waves die out quickly after input passes
"""
...
class CubeNet:
    def __init__(self,n=48,L=48,seed=0,
                 w0=0.6,input_gain=4.2,
                 rho=0.78,bias=0.015,noise=0.0,
                 eta=0.01,decay=0.001,
                 tau_ref=3,tau_adapt=40,d_theta=0.27,theta0=1.0):
